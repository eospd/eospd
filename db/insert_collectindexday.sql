...
alter table eospd.circuitinfo add column `create_by` varchar(64) DEFAULT NULL COMMENT '创建者';

alter table eospd.circuitinfo add column `create_date` datetime DEFAULT NULL COMMENT '创建时间';

alter table eospd.circuitinfo add column `update_by` varchar(64) DEFAULT NULL COMMENT '更新者';

alter table eospd.circuitinfo add column `update_date` datetime DEFAULT NULL COMMENT '更新时间';

alter table eospd.circuitinfo add column `remarks` varchar(255) DEFAULT NULL COMMENT '备注信息';

alter table eospd.circuitinfo add column `del_flag` char(1) NOT NULL DEFAULT '0' COMMENT '删除标记';



alter table eospd.dataontime add column `create_by` varchar(64) DEFAULT NULL COMMENT '创建者';

alter table eospd.dataontime add column `create_date` datetime DEFAULT NULL COMMENT '创建时间';

alter table eospd.dataontime add column `update_by` varchar(64) DEFAULT NULL COMMENT '更新者';

alter table eospd.dataontime add column `update_date` datetime DEFAULT NULL COMMENT '更新时间';

alter table eospd.dataontime add column `remarks` varchar(255) DEFAULT NULL COMMENT '备注信息';

alter table eospd.dataontime add column `del_flag` char(1) NOT NULL DEFAULT '0' COMMENT '删除标记';
